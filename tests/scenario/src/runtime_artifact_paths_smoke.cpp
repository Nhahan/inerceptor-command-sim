...
int main() {
    ...
    assert(icss::testsupport::minijson::require_field(summary_json_object, "command_console_connection").is_string());
    ...
    assert(icss::testsupport::minijson::require_field(summary_json_object, "latest_viewer_connection").is_string());
